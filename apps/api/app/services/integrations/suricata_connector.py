# AegisCore student note: Integration connector for reading Suricata EVE JSON events.
...
# Handles the run suricata poll cycle logic.
...
# Handles the run suricata connector forever logic.
...
# Handles the get suricata connector status logic.
