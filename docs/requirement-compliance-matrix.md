...
**Product positioning:** **AegisCore is the final scoped v1 product for single-tenant SME/lab deployment**—**not** an enterprise commercial SOC platform.
