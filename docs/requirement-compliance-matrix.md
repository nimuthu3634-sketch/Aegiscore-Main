...
| Centralized dashboard | Implemented | `apps/web/src/pages/OverviewPage.tsx`; `apps/web/src/components/layout/AppShell.tsx`; `apps/api/app/api/routes/dashboard.py`; `README.md` | Dashboard remains intentionally compact and local-scope, not enterprise BI. |
